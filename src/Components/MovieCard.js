            ...
            <div className="card_right__rating">
              <div className="card_right__rating__stars">
                <fieldset className="rating">
                  <input id="star10" name="rating" type="radio" defaultValue={10} />
                  <label className="full" htmlFor="star10" title="10 stars" />
                  <input id="star9half" name="rating" type="radio" defaultValue="9 and a half" />
                  ...
                  <input id="star8half" name="rating" type="radio" defaultValue="8 and a half" />
                  ...
                  <input id="star7half" name="rating" type="radio" defaultValue="7 and a half" />
                  ...
                  <input id="star6half" name="rating" type="radio" defaultValue="6 and a half" />
                  ...
                  <input id="star5half" name="rating" type="radio" defaultValue="5 and a half" />
                  ...
                  <input id="star4half" name="rating" type="radio" defaultValue="4 and a half" />
                  ...
                  <input id="star3half" name="rating" type="radio" defaultValue="3 and a half" />
                  ...
                  <input id="star2half" name="rating" type="radio" defaultValue="2 and a half" />
                  ...
                  <input id="star1half" name="rating" type="radio" defaultValue="1 and a half" />
                  ...
                  <input id="starhalf" name="rating" type="radio" defaultValue="half" />
