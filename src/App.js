...
function App() {
  let moviesData = [
     
    {
      id: Math.random(),
      image:
      "https://flxt.tmsimg.com/assets/p10866699_p_v10_ab.jpg",
      rating: 4,
      name: "Devil's Mile",
      date: "2014",
      type: "Action | Crime",
  ...
  const addMovie=(newMovie)=>(setMovies([newMovie, ...moviesData]));
  return (
    <div>
    <PrimarySearchAppBar  setsearchIteam = {setsearchIteam}/>
    <Movies   moviesData={moviesData} setsearchIteam={ setsearchIteam}/>
    <Footer/>
